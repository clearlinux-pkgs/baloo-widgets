...
Version  : 18.07.90
Release  : 5
URL      : https://github.com/KDE/baloo-widgets/archive/v18.07.90.tar.gz
Source0  : https://github.com/KDE/baloo-widgets/archive/v18.07.90.tar.gz
...
%prep
%setup -q -n baloo-widgets-18.07.90
...
export LANG=C
export SOURCE_DATE_EPOCH=1533392368
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BalooWidgets.so.18.7.90
