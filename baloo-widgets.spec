...
Version  : 18.12.1
Release  : 14
URL      : https://github.com/KDE/baloo-widgets/archive/v18.12.1.tar.gz
Source0  : https://github.com/KDE/baloo-widgets/archive/v18.12.1.tar.gz
...
%prep
%setup -q -n baloo-widgets-18.12.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1547135181
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BalooWidgets.so.18.12.1
