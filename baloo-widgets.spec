...
Source0  : https://download.kde.org/stable/release-service/22.12.0/src/baloo-widgets-22.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.0/src/baloo-widgets-22.12.0.tar.xz.sig
...
%prep
%setup -q -n baloo-widgets-22.12.0
cd %{_builddir}/baloo-widgets-22.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670521179
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BalooWidgets.so.22.12.0
