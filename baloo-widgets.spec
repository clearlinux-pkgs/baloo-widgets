...
Version  : 18.11.80
Release  : 11
URL      : https://github.com/KDE/baloo-widgets/archive/v18.11.80.tar.gz
Source0  : https://github.com/KDE/baloo-widgets/archive/v18.11.80.tar.gz
...
%prep
%setup -q -n baloo-widgets-18.11.80
...
export LANG=C
export SOURCE_DATE_EPOCH=1542511312
mkdir -p clr-build
pushd clr-build
%cmake ..
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BalooWidgets.so.18.11.80
