...
Version  : 18.08.3
Release  : 10
URL      : https://github.com/KDE/baloo-widgets/archive/v18.08.3.tar.gz
Source0  : https://github.com/KDE/baloo-widgets/archive/v18.08.3.tar.gz
...
%package abi
Summary: abi components for the baloo-widgets package.
Group: Default

%description abi
abi components for the baloo-widgets package.
...
%prep
%setup -q -n baloo-widgets-18.08.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1541688324
mkdir -p clr-build
pushd clr-build
%cmake ..
...
%files abi
%defattr(-,root,root,-)
/usr/share/abi/libKF5BalooWidgets.so.18.8.3.abi
/usr/share/abi/libKF5BalooWidgets.so.5.abi
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BalooWidgets.so.18.8.3
