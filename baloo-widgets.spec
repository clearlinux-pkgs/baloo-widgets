...
Source0  : https://github.com/KDE/baloo-widgets/archive/v18.08.1.tar.gz
...
%prep
%setup -q -n baloo-widgets-18.08.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1536299052
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BalooWidgets.so.18.8.1
