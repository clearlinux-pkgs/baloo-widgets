...
Version  : 25.04.2
Release  : 96
URL      : https://download.kde.org/stable/release-service/25.04.2/src/baloo-widgets-25.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/baloo-widgets-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/baloo-widgets-25.04.2.tar.xz.sig
...
%setup -q -n baloo-widgets-25.04.2
cd %{_builddir}/baloo-widgets-25.04.2
pushd ..
cp -a baloo-widgets-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749497980
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6BalooWidgets.so.25.04.2
...
/usr/lib64/libKF6BalooWidgets.so.25.04.2
