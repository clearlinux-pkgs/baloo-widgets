...
Version  : 24.12.0
Release  : 90
URL      : https://download.kde.org/stable/release-service/24.12.0/src/baloo-widgets-24.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/baloo-widgets-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/baloo-widgets-24.12.0.tar.xz.sig
...
%setup -q -n baloo-widgets-24.12.0
cd %{_builddir}/baloo-widgets-24.12.0
pushd ..
cp -a baloo-widgets-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735191724
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6BalooWidgets.so.24.12.0
...
/usr/lib64/libKF6BalooWidgets.so.24.12.0
