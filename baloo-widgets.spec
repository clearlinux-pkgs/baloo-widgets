...
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/baloo-widgets-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/baloo-widgets-24.12.1.tar.xz.sig
...
%setup -q -n baloo-widgets-24.12.1
cd %{_builddir}/baloo-widgets-24.12.1
pushd ..
cp -a baloo-widgets-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736526196
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6BalooWidgets.so.24.12.1
...
/usr/lib64/libKF6BalooWidgets.so.24.12.1
