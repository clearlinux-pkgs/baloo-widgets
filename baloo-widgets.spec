...
Source0  : https://download.kde.org/stable/release-service/22.08.2/src/baloo-widgets-22.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.2/src/baloo-widgets-22.08.2.tar.xz.sig
...
%prep
%setup -q -n baloo-widgets-22.08.2
cd %{_builddir}/baloo-widgets-22.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665711436
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BalooWidgets.so.22.08.2
