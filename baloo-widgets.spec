...
Version  : 24.12.3
Release  : 93
URL      : https://download.kde.org/stable/release-service/24.12.3/src/baloo-widgets-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/baloo-widgets-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/baloo-widgets-24.12.3.tar.xz.sig
...
%setup -q -n baloo-widgets-24.12.3
cd %{_builddir}/baloo-widgets-24.12.3
pushd ..
cp -a baloo-widgets-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742448261
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6BalooWidgets.so.24.12.3
...
/usr/lib64/libKF6BalooWidgets.so.24.12.3
