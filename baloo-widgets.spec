...
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/baloo-widgets-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/baloo-widgets-25.04.0.tar.xz.sig
...
%setup -q -n baloo-widgets-25.04.0
cd %{_builddir}/baloo-widgets-25.04.0
pushd ..
cp -a baloo-widgets-25.04.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744918831
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6BalooWidgets.so.25.04.0
...
/usr/lib64/libKF6BalooWidgets.so.25.04.0
