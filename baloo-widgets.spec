...
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/baloo-widgets-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/baloo-widgets-22.08.1.tar.xz.sig
...
%prep
%setup -q -n baloo-widgets-22.08.1
cd %{_builddir}/baloo-widgets-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662762880
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BalooWidgets.so.22.08.1
