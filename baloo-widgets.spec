...
Source0  : https://download.kde.org/stable/release-service/20.08.3/src/baloo-widgets-20.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.3/src/baloo-widgets-20.08.3.tar.xz.sig
...
%prep
%setup -q -n baloo-widgets-20.08.3
cd %{_builddir}/baloo-widgets-20.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604589478
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/baloo-widgets-20.08.3/COPYING %{buildroot}/usr/share/package-licenses/baloo-widgets/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/baloo-widgets-20.08.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/baloo-widgets/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/baloo-widgets-20.08.3/COPYING.README %{buildroot}/usr/share/package-licenses/baloo-widgets/6070c553a9e29baa98a1fb7ae983e8d7fa14b7d7
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BalooWidgets.so.20.8.3
