...
Version  : 22.04.2
Release  : 53
URL      : https://download.kde.org/stable/release-service/22.04.2/src/baloo-widgets-22.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.2/src/baloo-widgets-22.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.2/src/baloo-widgets-22.04.2.tar.xz.sig
...
%prep
%setup -q -n baloo-widgets-22.04.2
cd %{_builddir}/baloo-widgets-22.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654828662
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/baloo-widgets-22.04.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/baloo-widgets/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/baloo-widgets-22.04.2/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/baloo-widgets/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/baloo-widgets-22.04.2/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/baloo-widgets/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/baloo-widgets-22.04.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/baloo-widgets/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/baloo-widgets-22.04.2/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/baloo-widgets/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/baloo-widgets-22.04.2/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/baloo-widgets/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/baloo-widgets-22.04.2/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/baloo-widgets/19d98e1b6f8ef12849ea4012a052d3907f336c91
cp %{_builddir}/baloo-widgets-22.04.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/baloo-widgets/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/baloo-widgets-22.04.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/baloo-widgets/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/baloo-widgets-22.04.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/baloo-widgets/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/baloo-widgets-22.04.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/baloo-widgets/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BalooWidgets.so.22.04.2
