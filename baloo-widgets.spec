...
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/baloo-widgets-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/baloo-widgets-24.08.0.tar.xz.sig
...
%setup -q -n baloo-widgets-24.08.0
cd %{_builddir}/baloo-widgets-24.08.0
pushd ..
cp -a baloo-widgets-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724638252
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6BalooWidgets.so.24.08.0
...
/usr/lib64/libKF6BalooWidgets.so.24.08.0
