...
Version  : 24.02.2
Release  : 79
URL      : https://download.kde.org/stable/release-service/24.02.2/src/baloo-widgets-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/baloo-widgets-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/baloo-widgets-24.02.2.tar.xz.sig
...
%setup -q -n baloo-widgets-24.02.2
cd %{_builddir}/baloo-widgets-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713224654
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6BalooWidgets.so.24.02.2
...
/usr/lib64/libKF6BalooWidgets.so.24.02.2
