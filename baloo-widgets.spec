...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/baloo-widgets-22.08.0.tar.xz
...
%prep
%setup -q -n baloo-widgets-22.08.0
cd %{_builddir}/baloo-widgets-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661540006
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BalooWidgets.so.22.08.0
