...
Source0  : https://download.kde.org/stable/applications/19.04.3/src/baloo-widgets-19.04.3.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.3/src/baloo-widgets-19.04.3.tar.xz.sig
...
%prep
%setup -q -n baloo-widgets-19.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562852019
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BalooWidgets.so.19.4.3
