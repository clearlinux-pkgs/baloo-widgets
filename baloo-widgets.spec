...
Version  : 24.02.0
Release  : 76
URL      : https://download.kde.org/stable/release-service/24.02.0/src/baloo-widgets-24.02.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/baloo-widgets-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/baloo-widgets-24.02.0.tar.xz.sig
...
%prep
%setup -q -n baloo-widgets-24.02.0
cd %{_builddir}/baloo-widgets-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710379574
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6BalooWidgets.so.24.02.0
...
/usr/lib64/libKF6BalooWidgets.so.24.02.0
