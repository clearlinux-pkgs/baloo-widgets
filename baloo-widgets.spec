...
Source0  : https://download.kde.org/stable/release-service/23.08.0/src/baloo-widgets-23.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.0/src/baloo-widgets-23.08.0.tar.xz.sig
...
%prep
%setup -q -n baloo-widgets-23.08.0
cd %{_builddir}/baloo-widgets-23.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693010627
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5BalooWidgets.so.23.08.0
...
/usr/lib64/libKF5BalooWidgets.so.23.08.0
